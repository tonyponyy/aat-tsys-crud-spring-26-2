...
public class ProyectoController {
	...
	@GetMapping("/{id}")
	public Proyecto proyectoXID(@PathVariable(name="id") Integer id) {
	...
	@PutMapping("/{id}")
	public Proyecto actualizarproyecto(@PathVariable(name="id")Integer id,@RequestBody Proyecto proyecto) {
	...
	@DeleteMapping("/{id}")
	public void eliminarproyecto(@PathVariable(name="id")Integer id) {
