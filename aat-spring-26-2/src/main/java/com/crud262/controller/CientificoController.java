...
public class CientificoController {
	...
	@GetMapping("/{id}")
	public Cientifico cientificoXID(@PathVariable(name="id") Integer id) {
	...
	@PutMapping("/{id}")
	public Cientifico actualizarcientifico(@PathVariable(name="id")Integer id,@RequestBody Cientifico cientifico) {
	...
	@DeleteMapping("/{id}")
	public void eliminarcientifico(@PathVariable(name="id")Integer id) {
	...
	@Transactional
	public ResponseEntity<String> salvarCientificoProyecto(@RequestBody Cientifico cientifico, @PathVariable(name="id")int id) {
